...
KANGING_STR = [
 "Hello! This sticker has been saved. 😉👍 ",
]


@register(outgoing=True, pattern="^.svst")
async def kang(args):
...
CMD_HELP.update({
    "stickers":
    ".svst\
\nUsage: Reply .svst to a sticker or an image to kang it to your userbot pack.\
\n\n.svst [emoji('s)]\
\nUsage: Works just like .svst but uses the emoji('s) you picked.\
\n\n.svst [number]\
